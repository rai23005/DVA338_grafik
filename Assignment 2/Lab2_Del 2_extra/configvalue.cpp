...
Light sceneExtraLights[] = {
    
    { {-20.0f, 10.0f, 10.0f}, {0.2f, 0.2f, 0.2f}, {0.9f, 0.9f, 0.7f}, {1.0f, 1.0f, 1.0f} },
    { {0.0f, 20.0f, 10.0f}, {0.1f, 0.1f, 0.1f}, {1.0f, 0.9f, 0.7f}, {1.0f, 1.0f, 1.0f} },
    { {20.0f, 10.0f, 10.0f}, {0.5f, 0.5f, 0.5f}, {0.3f, 0.3f, 0.3f}, {0.6f, 0.6f, 0.6f} }
};
