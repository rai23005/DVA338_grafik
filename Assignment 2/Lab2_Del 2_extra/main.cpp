...
void display(void) {
	...
	*/
	...
	if ( activeShaderProgram == phongShaderProgram || activeShaderProgram == cartoonShaderProgram || activeShaderProgram == flatShaderProgram ) {
		SetLightUniforms(activeShaderProgram, sceneLight, cameraPositioned);
	}

	if (activeShaderProgram == phongExtraLightShaderProgram || activeShaderProgram == cartoonExtraLightShaderProgram) {
		SetExtraLightUniforms(activeShaderProgram, sceneExtraLights, max_Light, cameraPositioned);
	...
	while (mesh != NULL) {
		...
		if (activeShaderProgram == phongShaderProgram || activeShaderProgram == phongExtraLightShaderProgram || activeShaderProgram == cartoonShaderProgram || activeShaderProgram == cartoonExtraLightShaderProgram || activeShaderProgram == flatShaderProgram) {
...
void init(void) {
	...
	//Asigment extra 
	phongExtraLightShaderProgram = LoadShaderProgram(
		"../../DVA338_Lab1/phong_VertexShader.glsl",
		"../../DVA338_Lab1/phong_FragShader_extra_light.glsl");

	//cartoonExtraLightShaderProgram = LoadShaderProgram(
	//	"../../DVA338_Lab1/flat_VertexShader.glsl",
	//	"../../DVA338_Lab1/flat_FragShader.glsl");
	//	//"../../DVA338_Lab1/cartoon_FragShade_extra_light.glsl");
...
int main(int argc, char** argv) {
	...
	////Asigment 3.2
	//insertModel(&meshList, cube.nov, cube.verts, cube.nof, cube.faces, 5.0, cubePositioned, cubeRotation, cubeScale,  triceratopsMaterial);
	//insertModel(&meshList, knot.nov, knot.verts, knot.nof, knot.faces, 1.0, knotPositioned, knotRotation, knotScale, cowMaterial);
