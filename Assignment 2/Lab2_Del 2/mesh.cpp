//PArt 1-6, extra från 99
////LAb2_part 1 extra 
#include <stdlib.h>
#include "mesh.h"


void insertModel(Mesh** list, int nv, float* vArr, int nt, int* tArr, float scale, Vector positioned, Vector rotation, Vector vectorScale, Material material) {
